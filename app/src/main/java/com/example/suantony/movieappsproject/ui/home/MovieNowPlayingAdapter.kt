...
class MovieNowPlayingAdapter internal constructor() :
    PagedListAdapter<MovieNowPlayingItem, MovieNowPlayingAdapter.MovieViewHolder>(DIFF_CALLBACK) {
    ...
    companion object {
        private val DIFF_CALLBACK = object : DiffUtil.ItemCallback<MovieNowPlayingItem>() {
            override fun areItemsTheSame(
                oldItem: MovieNowPlayingItem,
                newItem: MovieNowPlayingItem
            ): Boolean {
    ...
    inner class MovieViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        fun bind(movie: MovieNowPlayingItem) {
            with(itemView) {
                Glide.with(context)
